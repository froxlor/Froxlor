...
class Cronjob
{
	...
	public static function inserttask($type, ...$params)
	{
		...
		if ($type == TaskId::REBUILD_VHOST || $type == TaskId::REBUILD_DNS || $type == TaskId::REBUILD_DKIM || $type == TaskId::CREATE_FTP || $type == TaskId::CREATE_QUOTA || $type == TaskId::REBUILD_CRON) {
