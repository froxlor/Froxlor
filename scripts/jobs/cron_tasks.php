...
// necessary includes
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.dns.10.bind.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.dns.20.pdns.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.10.apache.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.15.apache_fcgid.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.20.lighttpd.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.25.lighttpd_fcgid.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.30.nginx.php');
require_once makeCorrectFile(__DIR__ . '/cron_tasks.inc.http.35.nginx_phpfpm.php');
    ...
    if ($row['type'] === '1') {
        ...
        if (Settings::Get('phpfpm.enabled') === 1 && function_exists('posix_getgrnam')) {
            ...
            if (isset($groupinfo['members'])
                && !in_array(Settings::Get('system.httpuser'), $groupinfo['members'], true)
            ) {
