...
$lng['serversettings']['mysqlprefix']['description'] = 'Which prefix should MySQL accounts have?</br>Use "RANDOM" as value to get a 3-digit random prefix.</br>Use "DBNAME" as value to use mysql description field as db name (together with customer name prefix).';
