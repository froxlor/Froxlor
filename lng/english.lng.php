...
$lng['admin']['ipsandports']['ipnote'] = '<div id="ipnote" class="invalid-feedback">Note: Although private ip addresses are allowed, some features like DNS might not behave correctly.<br>Only use private ip addresses if you are sure.</div>';
...
$lng['2fa']['2fa_added'] = '2FA activated successfully<br><a class="alert-link" href="%s?page=2fa">View 2FA details</a>';
