...
$lng['serversettings']['logfiles_format']['title'] = 'Logfiles format';
$lng['serversettings']['logfiles_format']['description'] = 'In which format should the logfiles be stored? Format has to be created in webserver configuration first!';
