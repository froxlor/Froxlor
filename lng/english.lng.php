...
$lng['serversettings']['logfiles_directory2']['description'] = 'Where should all log files be stored? Optionally, you can specify a script here and use the placeholder <strong>{LOGFILE}</strong> if needed. In case of a custom script you will need to activate the <strong>logfiles piped</strong> option';
