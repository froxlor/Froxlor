...
return [
	...
	'error' => [
		...
		'loginnameissystemaccount' => 'Sie können keinen Account anlegen, der wie ein Systemaccount aussieht (also zum Beispiel mit "%s" anfängt). Bitte wählen Sie einen anderen Accountnamen.',
