...
$lng['menue']['extras']['directoryprotection'] = 'Ochrona katalogu';
...
$lng['domains']['description'] = 'Tutaj możesz utworzyć (pod-)domeny i ustawić ich ścieżki.<br />system po każdej zmianie potrzebuje trochę czasu na zastosowanie zmian.';
...
$lng['extras']['description'] = 'Tutaj możesz dodać trochę dodatków, na przykład ochronę katalogu.<br />System potrzebuje trochę czasu na zastosowanie zmian.';
...
$lng['error']['domains_cantdeletedomainwithemail'] = 'Nie możesz usunąć domeny która jest używana jako domena mailowa. Usuń najpierw wszystkie adresy mailowe.';
...
$lng['question']['domains_reallydelete'] = 'Na pewno chcesz usunąć domenę %s?';
$lng['question']['email_reallydelete'] = 'Na pewno chcesz usunąć adres email %s?';
$lng['question']['email_reallydelete_account'] = 'Czy Na pewno chcesz usunąć email z %s?';
$lng['question']['email_reallydelete_forwarder'] = 'Czy na pewno chcesz usunąć przekierowanie %s?';
$lng['question']['extras_reallydelete'] = 'czy na pewno chcesz usunąć ochronę katalogu %s?';
$lng['question']['extras_reallydelete_pathoptions'] = 'Czy na pewno chcesz usunąć opcje ścieżki %s?';
$lng['question']['ftp_reallydelete'] = 'Czy na pewno chcesz usunąć konto FTP %s?';
$lng['question']['mysql_reallydelete'] = 'Czy na pewno chcesz usunąć bazę %s? Operajca jest nieodwracalna!';
$lng['question']['admin_configs_reallyrebuild'] = 'Czy na pewno chcesz przebudować pliki konfguracyjne?';
$lng['question']['admin_customer_alsoremovefiles'] = 'Czy usunąć pliki użytkownika?';
$lng['question']['admin_customer_alsoremovemail'] = 'Całkowicie usunąć pliki email użytkownika ?';
$lng['question']['admin_customer_alsoremoveftphomedir'] = 'Usunąć ścieżkę użytkownika FTP?';
...
$lng['admin']['deactivated'] = 'Wyłączone';
...
$lng['error']['cantchangesystemip'] = 'Nie możesz usunąć ostatniego adresu IP, najpierw utwórz inną kombinację IP/Port dla systemu lub zmień systemowy IP.';
$lng['question']['admin_domain_reallydocrootoutofcustomerroot'] = 'Jesteś pewnien, że chcesz aby dokument root dla tej domeny, nie był w katalogu root klienta?';
...
$lng['error']['ipiswrong'] = '"Adres IP" jest zły. Tylko poprawne adresy są dozwolone.';
...
$lng['error']['pagingiswrong'] = '"Wpisów na stronę" wartość jest zła. Tylko numeryczne wartości są dozwolone.';
...
$lng['error']['stringformaterror'] = 'Wartość pola "%s" nie jest w poprawnym formacie.';
...
$lng['ticket']['ticket_view'] = 'Wyświetl plan zgłoszeń';
...
$lng['serversettings']['ticket']['noreply_name'] = 'Nazwa nadawcy maila w systemie zgłoszeń';
...
$lng['serversettings']['logger']['types']['description'] = 'Określ typy logów. Do zaznaczenia wielu, przytrzymaj CTRL podczas zaznaczania.<br />Dostępne typy logów: syslog, plikowy , mysql';
...
$lng['menue']['logger']['logger'] = 'Log-er Systemowy';   
...
$lng['error']['invalidip'] = 'Nieprawidłowy adres  IP: %s';
...
$lng['dkim']['dkimrestart_command']['title'] = 'Polecenie restartujące Milter-a';
...
$lng['dns']['a_record'] = 'Rekord A(IPv6 opcjonalnie)';
$lng['dns']['cname_record'] = 'Rekord CNAME';
...
$lng['dns']['txtrecords'] = 'Definiuj rekordy TXT';
...
$lng['serversettings']['selfdnscustomer']['title'] = 'Pozwól klientom na zmianę ustawień domeny';
...
$lng['panel']['megabyte'] = 'Maga Bajtów';
...
$lng['admin']['templates']['SERVERNAME'] = 'Zastąpiony przez nazwę serwera.';
...
$lng['admin']['templates']['filecontent'] = 'Zawartość pliku';
...
$lng['success']['clickheretocontinue'] = 'Naciśnij tutaj aby kontynuować';
...
$lng['tasks']['rebuild_webserverconfig'] = 'Przebuduj konfiguracje serwera web';
...
$lng['error']['hiddenfieldvaluechanged'] = 'Wartość dla ukrytego pola "%s" zostanie zmieniona gdy edytujesz to pole.<br /><br />
...
$lng['dkim']['dkim_algorithm']['title'] = 'Dozwolone algorytmy szyfrujące';
$lng['dkim']['dkim_algorithm']['description'] = 'Zdefiniuj dozwolone algorytmy szyfrujące, Wybierz "Wszystkie" dla wszystkich algorytmów lub 1 lub więcej z dostepnych algorytmów';
...
$lng['serversettings']['ticket']['default_priority'] = 'Domyślny priorytet zadania wsparcia technicznego';
...
$lng['serversettings']['mail_also_with_mxservers'] = 'Utwórz "A rekord" z ustawieniami serwera mx mail-, imap-, pop3- and smtp';
...
$lng['serversettings']['perl']['suexecworkaround']['description'] = 'Włącz tylko wtedy gdy klient docroots nie jest tylko apache suexec w ścieżce.<br />Jeśli włączone, Froxlor wygenerje link z katalogu klienta z włączonym perl + /cgi-bin/ dla danej ścieżki.<br />otka Perl może pracowac tylko z katalogiem /cgi-bin/ a nie w samym folderu (jak ma to miejsce bez tej poprawki!)';
...
$lng['question']['customer_reallyunlock'] = 'Na pewno chcesz odblokować klienta %s?';
...
$lng['serversettings']['phpreload_command']['description'] = 'Jest używana do przeładowania backendu PHP jeśli jest używany<br />Domyślnie: Puste<br />*nie używane z php-fpm';
...
$lng['serversettings']['phpfpm']['title'] = 'Włącz php-fpm';
...
$lng['mails']['trafficmaxpercent']['subject'] = 'Osiągałeś limit transferu';
...
$lng['admin']['templates']['MAX_PERCENT'] = 'Zastąpione przez (użycie przestrzni)/transfer limit do wysłania raportu.';
...
$lng['serversettings']['panel_allow_theme_change_customer'] = 'Pozwól klientom na zamianę skórki';
...
$lng['serversettings']['ssl']['ssl_cipher_list']['title'] = 'Konfiguruj dozwolone metody szyfrowania SSL';
...
$lng['serversettings']['allow_error_report_admin']['description'] = 'Proszę pamiętaj: nigdy nie wysyłaj prywatnych danych (klienta-)do Nas!';
$lng['serversettings']['allow_error_report_customer']['title'] = 'Pozwól klientom na raportowanie błędów w bazie do Froxlor-a';
...
$lng['question']['admin_integritycheck_reallyfix'] = 'Czy na pewno chcesz aby problemy z integralnością bazy były naprawiane automatycznie?';
...
$lng['integrity_check']['FroxlorLocalGroupMemberForFcgidPhpFpm'] = 'Użytkownik froxlor w grupie klientów (for FCGID/php-fpm)';
