...
$lng['menue']['ticket']['ticket'] = 'Потдръжка';
...
$lng['dns']['destinationip'] = 'Домейн IP';
...
$lng['domains']['redirectifpathisurlinfo'] = 'Трябва само да изберете, ако сте въвели URL като път.';
...
$lng['panel']['descriptionerrordocument'] = 'Can be an URL, path to a file or just a string wrapped around " "<br />Оставете празно, за да се използва стойност по подразбиране.';
