...
$lng['domains']['wildcarddomain'] = 'Создать как wildcarddomain?';
...
$lng['mails']['pop_success']['mailbody'] = 'Здравствуйте,\n\nyour mail аккаунт {EMAIL}\nwas создан успешно.\n\nЭто автоматическое сообщение \ne-mail, Пожалуйста не отвечайте на него!\n\nАдминистрация';
$lng['mails']['pop_success']['subject'] = 'Email аккаунт успешно создан!';
$lng['mails']['createcustomer']['mailbody'] = 'Здравствуйте {FIRSTNAME} {NAME},\n\nинформация о Вашем аккаунте:\n\nПользователь: {USERNAME}\nПароль: {PASSWORD}\n\nСпасибо,\nАдминистрация';
$lng['mails']['createcustomer']['subject'] = 'Информация об аккаунте';
...
$lng['admin']['configfiles']['commands'] = '<b>Команды:</b> Пожалуйста запустите команды в shell.';
...
$lng['serversettings']['ipaddress']['description'] = 'Какой IP-адрес у этого сервера?';
$lng['serversettings']['hostname']['title'] = 'Имя Сервера';
$lng['serversettings']['hostname']['description'] = 'Какое имя у этого сервера?';
$lng['serversettings']['apachereload_command']['title'] = 'Перезапустить команды Web-сервера';
$lng['serversettings']['apachereload_command']['description'] = 'Какие команды перезапустят файл конфигурации web-сервера?';
$lng['serversettings']['bindenable']['title'] = 'Включить Сервер имен';
$lng['serversettings']['bindenable']['description'] = 'Здесь может быть вкючен или выключен Сервер имен.';
$lng['serversettings']['bindconf_directory']['title'] = 'Привязать каталог конфигурации';
$lng['serversettings']['bindconf_directory']['description'] = 'Где сохранять конфигурации?';
$lng['serversettings']['bindreload_command']['title'] = 'Привязка команды перезапуска';
$lng['serversettings']['bindreload_command']['description'] = 'What\'s the bind command to reload bind configfiles?';
$lng['serversettings']['binddefaultzone']['title'] = 'Привязать зону по умолчанию';
$lng['serversettings']['binddefaultzone']['description'] = 'Какое имя у зоны по умолчанию?';
...
$lng['serversettings']['adminmail']['title'] = 'Отправитель';
...
$lng['serversettings']['webmail_url']['title'] = 'URL для входа в Web-почту';
$lng['serversettings']['webmail_url']['description'] = 'Какой URL для входа в Web-почту? (должен быть запущен http(s)://)';
$lng['serversettings']['webftp_url']['title'] = 'WebFTP URL';
$lng['serversettings']['webftp_url']['description'] = 'Какой URL для WebFTP? (должен быть запущен http(s)://)';
$lng['serversettings']['language']['description'] = 'Язык сервера по умолчанию?';
$lng['serversettings']['maxloginattempts']['title'] = 'Максимальное количество попыток входа';
$lng['serversettings']['maxloginattempts']['description'] = 'Максимальное количество попыток входа, перед блокировкой аккаунта.';
$lng['serversettings']['deactivatetime']['title'] = 'Время окончания бана';
$lng['serversettings']['deactivatetime']['description'] = 'Время в секундах, до завершения бана.';
...
$lng['serversettings']['nameservers']['title'] = 'Сервера имен';
...
$lng['serversettings']['mxservers']['title'] = 'MX сервера';
