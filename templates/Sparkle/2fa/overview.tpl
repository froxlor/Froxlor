...
<article>
	<header>
		<h2>
			...
			{\Froxlor\I18N\Lang::getAll()['login']['2fa']}
		</h2>
	</header>
	...
	<section>
		...
		<form method="post"
			...
			<p>{\Froxlor\I18N\Lang::getAll()['2fa']['2fa_overview_desc']}</p>
		...
		<form method="post"
			...
			<p>{\Froxlor\I18N\Lang::getAll()['2fa']['2fa_email_desc']}</p>
		...
		<form method="post"
			action="{$linker->getLink(array('section' => 'index', 'page' => $page, 'action' => 'delete'))}">
			<p>{\Froxlor\I18N\Lang::getAll()['2fa']['2fa_ga_desc']}</p>
