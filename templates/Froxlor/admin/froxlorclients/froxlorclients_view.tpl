$header
	<form action="$filename" method="post">
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="4"><b><img src="images/title.gif" alt="" />&nbsp;{$lng['menue']['multiserver']['clients']}&nbsp;"{$client->Get('name')}"</b></td>
			</tr>
			<tr>
				<td class="field_name_border_left">
					<img src="./images/multiserver/server.png" alt="Client #{$row['id']}" style="border:0;" />
				</td>
			...
			<tr>
				<td class="field_name_border_left" colspan="4" style="text-align:right;">
					...
					<a href="$filename?s=$s&amp;page=$page&amp;action=settings&amp;id={$id}" title="{$lng['admin']['froxlorclients']['settings']}">
						<img src="./images/multiserver/settings.png" alt="{$lng['admin']['froxlorclients']['settings']}" style="border:0;" />
					</a>&nbsp;
					<a href="$filename?s=$s&amp;page=$page&amp;action=deploy&amp;id={$id}" title="{$lng['admin']['froxlorclients']['deploy']}">
						<img src="./images/multiserver/deploy.png" alt="{$lng['admin']['froxlorclients']['deploy']}" style="border:0;" />
					</a>&nbsp;
					<else>
						<img src="./images/multiserver/settings_dis.png" alt="{$lng['admin']['froxlorclients']['settings']} :: {$lng['admin']['froxlorclients']['clientdisabled']}" style="border:0;" />&nbsp;
						<img src="./images/multiserver/deploy_dis.png" alt="{$lng['admin']['froxlorclients']['deploy']} :: {$lng['admin']['froxlorclients']['clientdisabled']}" style="border:0;" />
					</if>
					<a href="$filename?s=$s&amp;page=$page&amp;action=edit&amp;id={$id}" title="{$lng['panel']['edit']}">
						<img src="./images/multiserver/edit.png" alt="{$lng['panel']['edit']}" style="border:0;" />
					</a>&nbsp;
					<a href="$filename?s=$s&amp;page=$page&amp;action=delete&amp;id={$id}" title="{$lng['panel']['delete']}">
						<img src="./images/multiserver/trash.png" alt="{$lng['panel']['delete']}" style="border:0;" />
					</a>
				</td>
			</tr>
		</table>
			...
			<tr>
				<td class="field_name_border_left" colspan="2" style="text-align:right;">
					...
					<a href="$filename?s=$s&amp;page=$page&amp;action=refreshsysinfo&amp;id={$id}" title="{$lng['admin']['froxlorclients']['refreshsysinfo']}">
						<img src="./images/multiserver/refresh.png" alt="{$lng['admin']['froxlorclients']['refreshsysinfo']}" style="border:0;" />
					</a>
					<else>
						<img src="./images/multiserver/refresh_dis.png" alt="{$lastrefresh}" style="border:0;" />
					</if>
				</td>
			</tr>
			</if>
