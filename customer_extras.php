...
if ($page === 'overview') {
    ...
    if ($action === '') {
        ...
        if (isset($_POST['send']) && $_POST['send'] === 'send') {
            ...
            $htpasswd_add_data = include_once __DIR__ . '/lib/formfields/customer/extras/formfield.htpasswd_add.php';
        ...
        if (isset($result['username']) && $result['username'] !== '') {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $htpasswd_edit_data = include_once __DIR__ . '/lib/formfields/customer/extras/formfield.htpasswd_edit.php';
    ...
    if ($action === '') {
        ...
        if (isset($_POST['send']) && $_POST['send'] === 'send') {
            ...
            $htaccess_add_data = include_once __DIR__ . '/lib/formfields/customer/extras/formfield.htaccess_add.php';
        ...
        if ((isset($result['customerid'])) && ($result['customerid'] !== '') && ($result['customerid'] === $userinfo['customerid'])) {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $htaccess_edit_data = include_once __DIR__ . '/lib/formfields/customer/extras/formfield.htaccess_edit.php';
    ...
    if (Settings::Get('system.backupenabled') === 1) {
        ...
        if ($action === '') {
            ...
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $pathSelect = makePathfield($userinfo['documentroot'], $userinfo['guid'], $userinfo['guid']);
                $backup_data = include_once __DIR__ . '/lib/formfields/customer/extras/formfield.backup.php';
