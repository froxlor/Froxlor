    ...
    if ($action === 'add') {
        if ((int) $userinfo['change_serversettings'] === 1) {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $phpconfig_add_data = include_once __DIR__ . '/lib/formfields/admin/phpconfig/formfield.phpconfig_add.php';
    ...
    if ($action === 'edit') {
        ...
        if ($result['id'] !== 0 && $result['id'] === $id && (int) $userinfo['change_serversettings'] === 1) {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $phpconfig_edit_data = include_once __DIR__ . '/lib/formfields/admin/phpconfig/formfield.phpconfig_edit.php';
    ...
    if ($action === 'add') {
        if ((int) $userinfo['change_serversettings'] === 1) {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $fpmconfig_add_data = include_once __DIR__ . '/lib/formfields/admin/phpconfig/formfield.fpmconfig_add.php';
    ...
    if ($action === 'edit') {
        ...
        if ($result['id'] !== 0 && $result['id'] === $id && (int) $userinfo['change_serversettings'] === 1) {
            if (isset($_POST['send']) && $_POST['send'] === 'send') {
                ...
                $fpmconfig_edit_data = include_once __DIR__ . '/lib/formfields/admin/phpconfig/formfield.fpmconfig_edit.php';
