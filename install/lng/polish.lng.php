...
$lng['requirements']['openbasedirenabled'] = 'Froxlor nie pracuje poprawnie jeśli open_basedir jest włączone. Proszę wyłączyć open_basedir dla Froxlor w pliku php.ini';
...
$lng['install']['admin_pass2'] = 'Administrator-Hasło (potwierdzanie)';
