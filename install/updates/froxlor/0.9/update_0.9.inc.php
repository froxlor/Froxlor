...
if (isFroxlorVersion('0.9.34-dev4') || isFroxlorVersion('0.9.34')) {
	$do_update = true;
	showUpdateStep("Updating from 0.9.34 to 0.9.35-dev1", false);

	if ($_POST['current_backup_exists']!='1') {
		$do_update = false;
		lastStepStatus(2, 'aborted. Backup your database to continue.');
	} else {
		lastStepStatus(0);
	}
